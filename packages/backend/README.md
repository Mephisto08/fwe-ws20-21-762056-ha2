...
## Routen
- Alle Routen sind als POSTMAN-Collection auch unter dem Ordner [packages/backend/postmanCollection](packages/backend/postmanCollection) als JSON-File abgelegt. In diesen müssen lediglich die Route angepasst werden, wenn eine Id selektiert werden soll etc.
